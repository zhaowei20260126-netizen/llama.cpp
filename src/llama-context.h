...
struct llama_context {
    ...
    void set_ema_kv_active(bool value);
    void set_ema_kv_select_callback(llama_ema_kv_select_callback callback, void * user_data);
    void set_stream_kv_active(bool value);
